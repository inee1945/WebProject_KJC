...
<input type="password" class="form-control" id="exampleInputPassword1" name="pass">
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <a class="text-primary fw-bold" href="../main/index.do">Forgot Password ?</a>
                  </div>
<input type= "submit" value ="LoigIn[로그인]" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">
