    ...
    <aside class="left-sidebar">
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="../main/index.do" class="text-nowrap logo-img">
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="../main/index.do" aria-expanded="false">
                <span>
...
<c:choose>
    ...
    <div class="body-wrapper">
     ...
     <c:if test="${not empty SessionId }">
     	<strong>${SessionName }</strong>님 ,로그인 하셨습니다. 
     </c:if> 
 ...
 <c:choose>
 	<c:when test="${ not empty SessionId }">
 	  <!-- 로그인상태 -->
 		<a href="../member/logout.do" class="btn btn-outline-primary mx-3 mt-2 d-block">Logout</a>
 	</c:when>
 	<c:otherwise>
 		<a href="../member/login.do" class="btn btn-outline-primary mx-3 mt-2 d-block">Login</a>
 	</c:otherwise>
 </c:choose>                   
